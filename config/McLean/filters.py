# Retool exclude flags for McLean configuration
...
#
# McLean configuration:
# Excludes: Applications (a), Audio (A), BIOS (B), bad dumps (b), Coverdiscs (c), Demos (d), Add-ons (D), Educational (e), Fixed (f), MIA (k), Manuals (m), Multimedia (M), Bonus discs (o), Pirate (p), Preproduction (P), Promotional (r), Unlicensed (u), Video (v)
# Includes: N/A
exclude = "AaBbcdDefkmMopPruv"
