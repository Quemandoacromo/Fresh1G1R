# Retool exclude flags for PropeR configuration
...
# Excludes: Applications (a), Audio (A), bad dumps (b), BIOS (B), Coverdiscs (c), Demos (d), MIA (k), Manuals (m), Multimedia (M), Pirate (p), Preproduction (P), Unlicensed (u), Video (v)
# Includes: Add-ons (D), Educational (e), Fixed (f), Bonus discs (o), Promotional (r)
exclude = "AabBcdkMmpPuv"
